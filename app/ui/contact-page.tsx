  ...
  const d =
    lang === 'Marathi'
      ...
      : lang === 'Hindi'
        ? [
            'संपर्क करें',
            'एक अधिक जागरूक अनुष्ठान शुरू करें।',
            'उत्पाद, बिक्री या हमारे उद्देश्य के बारे में जानने के लिए संदेश भेजें।',
            'आपका नाम',
            'ईमेल पता',
            'आपका संदेश',
            'संदेश भेजें',
            'धन्यवाद।',
            'आपका संदेश प्राप्त हो गया है। हम जल्द संपर्क करेंगे।',
