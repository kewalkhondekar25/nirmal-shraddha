...
export const products: Product[] = [
  {
    ...
    packagingStory: {
      ...
      Hindi:
        'देव चरणों में अर्पित पवित्र फूलों का सम्मानपूर्वक पुनर्चक्रण कर हम पर्यावरण-अनुकूल अगरबत्ती बनाते हैं। प्रत्येक अगरबत्ती श्रद्धा, शुद्धता, सुगंध और प्रकृति संरक्षण की अविस्मरणीय अनुभूति है।',
    },
    features: [
      {
        English: '1 hour of aromatic burning',
        Marathi: '१ तास सुगंधी ज्वलन',
        Hindi: '१ घंटे तक सुगंधमय ज्वलन',
      },
      {
    ...
    description: {
      ...
      Hindi:
        'एकवीरा मातृकृपा देवी एकवीरा को समर्पित है — मातृशक्ति और अटल श्रद्धा की सुगंध। पवित्र निर्माल्य से बनी यह अगरबत्ती सुबह की आरती, पारिवारिक पूजा और रक्षक कृपा की प्रार्थना के लिए उपयुक्त है।',
    },
    essence: {
      English: 'Warm floral strength with a sacred, grounding finish.',
      Marathi: 'उबदार फुलांची शक्ती आणि पवित्र, स्थिर शेवट.',
      Hindi: 'गर्म फूलों की शक्ति और पवित्र, स्थिर अंत।',
    },
    devotion: {
      ...
      Hindi: 'सुबह की आरती, घर के देवघर और संरक्षण की प्रार्थना के लिए उत्तम।',
    },
  },
  {
    ...
    tagline: {
      ...
      Hindi: 'श्रद्धा की सुगंध, सबूरी का अनुभव।',
    },
    packagingLine: {
      English: 'Premium Incense Sticks',
      Marathi: 'प्रीमियम अगरबत्ती',
    ...
    imagery: [
      {
        ...
        Hindi: 'शिर्डी साईबाबा मंदिर और द्वारकामाई',
      },
      {
    ...
    description: {
      ...
      Hindi:
        'साईनाथ श्रद्धा साई की शांत भक्ति जगाती है — सरल श्रद्धा, समर्पण और सबूरी। संध्या प्रार्थना, ध्यान या जब स्थान शांत और करुणामय लगे, तब इसे जलाएँ।',
    },
    essence: {
      English: 'Balanced fragrance with soft wood and floral devotion.',
      Marathi: 'मृदू लाकूड व फुलांच्या भक्तीने संतुलित सुगंध.',
      Hindi: 'कोमल लकड़ी और फूलों की भक्ति से संतुलित सुगंध।',
    },
    devotion: {
  ...
  },
  {
    ...
    packagingStory: {
      ...
      Hindi:
        'वारकरी भक्ति से प्रेरित, विट्ठल भक्तिरंग दैनिक पूजा में भक्ति का रंग लाता है — पवित्र फूलों के अर्पण का सम्मानपूर्वक पर्यावरण-अनुकूल अगरबत्ती में रूपांतर।',
    },
    features: [
      {
        English: '1 hour of aromatic burning',
    ...
    description: {
      ...
      Hindi:
        'विट्ठल भक्तिरंग वारकरी प्रेरणा से उज्ज्वल और उत्साहवर्धक सुगंध देता है। अभंग गायन, कीर्तन और जहाँ आनंद व भक्ति एक साथ हों, वहाँ उपयुक्त।',
    },
    essence: {
      English: 'Bright floral lift with a joyful sacred trail.',
      Marathi: 'उजळ फुलांचा सुगंध आणि आनंदी पवित्र शेवट.',
      Hindi: 'उज्ज्वल फूलों की सुगंध और आनंदमय पवित्र महक।',
    },
    devotion: {
      ...
      Hindi: 'विट्ठल पूजा, कीर्तन और उत्सवी सभाओं के लिए उपयुक्त।',
    },
  },
  {
    ...
    packagingStory: {
      ...
      Hindi:
        'स्थान के रक्षक भाव को समर्पित, वेताल क्षेत्रपाल पवित्र निर्माल्य से बनता है — अर्पण को घर और दहलीज के लिए संरक्षक सुगंध में बदलता है।',
    },
    features: [
      {
        English: '1 hour of aromatic burning',
    ...
    description: {
      ...
      Hindi:
        'वेताल क्षेत्रपाल दहलीज शुद्ध करने, संध्या प्रार्थना और घर में जागरूक शांति बनाने के लिए गहरी संरक्षक अगरबत्ती है।',
    },
    essence: {
      English: 'Earthy depth with a clean, protective edge.',
      Marathi: 'मातीचा खोल सुगंध आणि स्वच्छ, रक्षक भाव.',
      Hindi: 'मिट्टी जैसी गहराई के साथ स्वच्छ, रक्षक भाव।',
    },
    devotion: {
      ...
      Hindi: 'दहलीज अनुष्ठान, संध्या प्रार्थना और घर की सुरक्षा के लिए उपयुक्त।',
    },
  },
  {
    ...
    packagingStory: {
      ...
      Hindi:
        'खंडोबा की योद्धा-भक्त ऊर्जा से प्रेरित, यह अगरबत्ती पवित्र फूलों के अर्पण को साहस, सामर्थ्य और उत्सवी भक्ति की तेजस्वी सुगंध में बदलती है।',
    },
    features: [
      {
        English: '1 hour of aromatic burning',
    ...
    description: {
      ...
      Hindi:
        'खंडोबा मल्हार महत्वपूर्ण आरंभ, शक्ति के उत्सव और संकल्प व तेज चाहने वाली पूजा के लिए प्रबल और स्पष्ट सुगंध देता है।',
    },
    essence: {
      English: 'Spiced warmth with a radiant, assertive trail.',
      Marathi: 'मसालेदार उबदारपणा आणि तेजस्वी, ठसठशीत शेवट.',
      Hindi: 'मसालेदार गर्माहट और तेजस्वी, प्रभावशाली सुगंध।',
    },
    devotion: {
  ...
  },
  {
    ...
    packagingStory: {
      ...
      Hindi:
        'गाँवदेवी मंगलम् ग्रामदेवी का सम्मान करती है — सामुदायिक आशीर्वाद और दैनिक मंगलता — पवित्र फूलों के अर्पण को सम्मानपूर्वक पर्यावरण-अनुकूल अगरबत्ती में नया जीवन देकर।',
    },
    features: [
      {
        English: '1 hour of aromatic burning',
    ...
    description: {
      ...
      Hindi:
        'घर के उत्सवों, नए घर और सामूहिक कल्याण की प्रार्थना के लिए कोमल, स्वागतशील अगरबत्ती — गाँवदेवी का आशीर्वाद दैनिक पूजा में लाने वाली।',
    },
    essence: {
      English: 'Soft auspicious florals with a welcoming glow.',
      Marathi: 'मृदू मंगल फुलांचा सुगंध आणि स्वागतशील तेज.',
      Hindi: 'कोमल मंगल फूलों की सुगंध और स्वागतशील आभा।',
    },
    devotion: {
      ...
      Hindi: 'गृहप्रवेश, पारिवारिक सभा और ग्रामदेवी पूजा के लिए सुंदर।',
    },
  },
]
