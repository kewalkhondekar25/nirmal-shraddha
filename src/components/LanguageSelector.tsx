...
export const LanguageSelector: React.FC<LanguageSelectorProps> = ({ variant = 'header' }) => {
  ...
  return (
    <div className="flex items-center gap-1.5 bg-indigo-950/90 p-1 rounded-full border border-amber-400/40 text-xs shadow-md">
      <div className="pl-2 pr-1 text-amber-300 flex items-center gap-1">
