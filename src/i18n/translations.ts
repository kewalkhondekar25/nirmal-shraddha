...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    inquireNow: 'Stockist & Bulk Orders',
    stockistInquiry: 'Wholesale Inquiry',
  ...
  mr: {
    ...
    inquireNow: 'घाऊक व वितरण चौकशी',
    stockistInquiry: 'विक्रेता चौकशी',
  ...
  hi: {
    ...
    inquireNow: 'थोक व वितरक पूछताछ',
    stockistInquiry: 'विक्रेता पूछताछ',
